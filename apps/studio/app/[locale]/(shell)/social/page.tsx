...
import { SocialQueue, type QueuedPostView } from '@/components/social-queue'
...
import { toArticleView } from '@kurasikapa/web-kit/read-model/article-view'
...
export default async function SocialPage({
  ...
  if (!actor.can('social:publish')) redirect(`/${locale}`)
