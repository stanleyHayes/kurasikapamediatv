...
import { createAndActivateAdCampaign, createAndActivateAffiliateLink, createAndActivateMembershipPlan, createAndActivateProduct, publishClassified } from '@kurasikapa/web-kit/bff/revenue'
