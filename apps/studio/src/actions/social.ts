...
import { parseInput, proposeSocialCaptionSchema } from '@kurasikapa/web-kit/actions/schemas'
...
/**
 * AI caption proposal for one platform. Persists nothing — the editor must
 * still accept it into the caption field and schedule (ADR-0005).
 *
 * Distinct from `proposeSocialSummaryAction` above: that one writes a short
 * summary of the article, this one writes the caption and hashtags for a
 * specific platform, whose conventions differ. The compose form offers both.
 */
