...
const GROUPS: readonly { heading: string; items: readonly NavItem[] }[] = [
  ...
  { heading: 'Administration', items: [
    ...
    { href: '/seo', label: 'SEO Center', description: 'Search readiness and story fixes', icon: 'search' },
    { href: '/ads', label: 'Ads', description: 'Advertiser budgets and placements', icon: 'social' },
