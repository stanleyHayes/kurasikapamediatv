...
test.describe('signed in', () => {
  ...
  test('newsroom analytics is accessible to an editor', async ({ page }) => {
    await signIn(page)
    await page.goto(`${STUDIO}/en/analytics`)
    await expect(page.getByRole('heading', { name: 'Newsroom analytics', level: 1 })).toBeVisible()
