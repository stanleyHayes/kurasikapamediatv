...
const GROUPS = [
  ...
  { title: 'Information', icon: 'help', links: [{ href: '/shop', label: 'Shop', icon: 'briefcase' }, { href: '/classifieds', label: 'Classifieds', icon: 'search' }, { href: '/support', label: 'Support us', icon: 'people' }, { href: '/advertise', label: 'Advertise', icon: 'broadcast' }, { href: '/help', label: 'Help centre', icon: 'help' }, { href: '/faq', label: 'FAQ', icon: 'help' }, { href: '/legal/privacy', label: 'Privacy', icon: 'privacy' }, { href: '/legal/terms', label: 'Terms', icon: 'scale' }, { href: '/legal/cookies', label: 'Cookies', icon: 'cookie' }] },
] as const
