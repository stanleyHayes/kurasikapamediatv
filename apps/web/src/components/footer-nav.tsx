...
const GROUPS = [
  { title: 'Reporting', icon: 'reporting', links: [{ href: '/news', label: 'Latest news', icon: 'newspaper' }, { href: '/podcasts', label: 'Podcasts', icon: 'broadcast' }, { href: '/galleries', label: 'Visual stories', icon: 'section' }, { href: '/sections/politics', label: 'Politics', icon: 'section' }, { href: '/sections/business', label: 'Business', icon: 'briefcase' }, { href: '/sections/education', label: 'Education', icon: 'building' }] },
