...
const GROUPS = [
  { title: 'Reporting', icon: 'reporting', links: [{ href: '/news', label: 'Latest news', icon: 'newspaper' }, { href: '/podcasts', label: 'Podcasts', icon: 'broadcast' }, { href: '/galleries', label: 'Visual stories', icon: 'section' }, { href: '/events', label: 'Events & summits', icon: 'people' }, { href: '/sections/politics', label: 'Politics', icon: 'section' }, { href: '/sections/business', label: 'Business', icon: 'briefcase' }, { href: '/sections/education', label: 'Education', icon: 'building' }] },
  ...
  { title: 'Information', icon: 'help', links: [{ href: '/shop', label: 'Shop', icon: 'briefcase' }, { href: '/classifieds', label: 'Classifieds', icon: 'search' }, { href: '/partners', label: 'Partner picks', icon: 'briefcase' }, { href: '/support', label: 'Support us', icon: 'people' }, { href: '/advertise', label: 'Advertise', icon: 'broadcast' }, { href: '/help', label: 'Help centre', icon: 'help' }, { href: '/faq', label: 'FAQ', icon: 'help' }, { href: '/legal/privacy', label: 'Privacy', icon: 'privacy' }, { href: '/legal/terms', label: 'Terms', icon: 'scale' }, { href: '/legal/cookies', label: 'Cookies', icon: 'cookie' }] },
] as const
