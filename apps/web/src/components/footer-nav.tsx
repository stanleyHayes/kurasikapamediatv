...
const GROUPS = [
  ...
  { title: 'Information', icon: 'help', links: [{ href: '/advertise', label: 'Advertise', icon: 'broadcast' }, { href: '/faq', label: 'Help and FAQ', icon: 'help' }, { href: '/legal/privacy', label: 'Privacy', icon: 'privacy' }, { href: '/legal/terms', label: 'Terms', icon: 'scale' }, { href: '/legal/cookies', label: 'Cookies', icon: 'cookie' }] },
] as const
