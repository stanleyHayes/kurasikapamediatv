...
export function buildContainer(infra: Infrastructure): Container {
  ...
  return {
    ...
    recordPageView: new RecordPageView({ articles: graph.articles, insights: graph.insights, clock: infra.clock, ids: infra.ids }),
    recordArticleEngagement: new RecordArticleEngagement({ articles: graph.articles, insights: graph.insights, clock: infra.clock, ids: infra.ids }),
    buildNewsroomReport: new BuildNewsroomReport({ insights: graph.insights, clock: infra.clock }),
