...
/**
 * One entry in an article's history panel.
 *
 * Declared here rather than beside the component that renders it. The BFF
 * loader builds these, and a loader that imports a React component for its
 * return type points the dependency the wrong way — which is exactly what
 * blocked the studio from moving into its own deployment.
 */
