...
func problemFor(err error) Problem {
	...
	case errors.Is(err, domainmedia.ErrInvalidAssetKind),
		...
		errors.Is(err, domainmedia.ErrInvalidEventType),
		errors.Is(err, domainmedia.ErrInvalidEventMode),
		errors.Is(err, domainmedia.ErrEmptyEventTitle),
		errors.Is(err, domainmedia.ErrEmptyEventSummary),
		errors.Is(err, domainmedia.ErrInvalidEventIdentity),
		errors.Is(err, domainmedia.ErrInvalidEventWindow),
		errors.Is(err, domainmedia.ErrEmptyEventTimezone),
		errors.Is(err, domainmedia.ErrEventNeedsVenue),
		errors.Is(err, domainmedia.ErrInvalidRegistrationURL),
	...
	case errors.Is(err, editorial.ErrIllegalTransition),
		...
		errors.Is(err, domainmedia.ErrEventAlreadyEnded),
		errors.Is(err, appmedia.ErrEventImageNotReady),
